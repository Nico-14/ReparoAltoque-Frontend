        ...
        <Container className="content">
              ...
              <Row>
                <Col md="4" className="mt-3 border-md-0">
                  ...
                  >
                    ...
                    <p className="title text-capitalize">twitter</p>
                ...
                <Col md="4" className="mt-3">
                  ...
                  >
                    ...
                    <p className="title text-capitalize">facebook</p>
                    <p className="subtitle">compartir</p>
                  </a>
                </Col>
                <Col md="4" className="mt-3">
                  ...
                  >
                    ...
                    <p className="title text-capitalize">WhatsApp</p>
                    <p className="subtitle">compartir</p>
                  </a>
                </Col>
              </Row>
            ...
            <Col className="column pt-3" md="7">
              ...
              <div className="links-vertial">
                <p>
                  ...
                  consectetur ipsum voluptas eos tempore atque ad aliquam totam
                  ullam commodi, quibusdam, dolores quasi. Maxime quod velit,
                  quaerat facilis esse sunt.
                </p>
              </div>
            </Col>
          </Row>
          ...
          <div className="column">
            <ul className="d-flex justify-content-center">
              <li>
                <a className="nav-link">Terminos & Condiciones</a>
              </li>
              <li>
                <a className="nav-link">Politica de Privacidad</a>
              </li>
              <li>
                <a className="nav-link">Autores del Sitio Web</a>
              </li>
            </ul>
          </div>
        </Container>
